...
extension UIViewController {
    ...
    func showAlert(withTitle title: String?, message: String?) {
        ...
        let rangetitle = NSRange(location: 0, length: attributedtitleText.length)
        attributedtitleText.addAttribute(NSAttributedString.Key.kern, value: 1.5, range: rangetitle)
        attributedtitleText.addAttribute(NSAttributedString.Key.font, value: UIFont(name: "HelveticaNeue-Bold", size: 17.0)!, range: rangetitle)
        ...
        attributedText.addAttribute(NSAttributedString.Key.font, value: UIFont(name: "HelveticaNeue", size: 15.0)!, range: range)
