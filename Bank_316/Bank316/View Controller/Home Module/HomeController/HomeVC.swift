...
class HomeVC: UIViewController {
    ...
    @IBOutlet weak var tradingWidthConstraint: NSLayoutConstraint!
    @IBOutlet weak var pointEarnedLeadingConstraint: NSLayoutConstraint!
    @IBOutlet weak var tradingLeadingConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        self.setTradingLeadingConstraint()
    ...
    func setTradingLeadingConstraint(){
        print(UIScreen.main.bounds.width)
        let size = UIScreen.main.bounds.width
        self.tradingWidthConstraint.constant = size * 0.302
        self.pointEarnedLeadingConstraint.constant = size * 0.1627
        self.tradingLeadingConstraint.constant = size * 0.12558
    }
