...
struct ClientModel : Codable {
	...
	let doc_verified_status : String?
	...
	enum CodingKeys: String, CodingKey {
		...
		case doc_verified_status = "doc_verified_status"
	...
	init(from decoder: Decoder) throws {
		...
		doc_verified_status = try? values.decode(String.self, forKey: .doc_verified_status)
